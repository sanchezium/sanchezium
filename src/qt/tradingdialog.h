...
private slots:
    ...
    QString BuySNCZ(QString OrderType, double Quantity, double Rate);
    QString SellSNCZ(QString OrderType, double Quantity, double Rate);
